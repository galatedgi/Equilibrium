...
from backEnd.pyAudioAnalysis.pyAudioAnalysis import audioBasicIO
from backEnd.pyAudioAnalysis.pyAudioAnalysis import audioTrainTest as at
from backEnd.pyAudioAnalysis.pyAudioAnalysis import MidTermFeatures as mtf
from backEnd.pyAudioAnalysis.pyAudioAnalysis import ShortTermFeatures as stf
...
def speaker_diarization(filename, n_speakers, mid_window=2.0, mid_step=0.2,
    ...
    if plot_res:
        ...
        plt.savefig("../backEnd/data/tmp/speakers_plot.png")
